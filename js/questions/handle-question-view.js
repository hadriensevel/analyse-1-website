...
async function sendBookmark(questionId, bookmark) {
    ...
    axios[method](`${baseUrl}/api/bookmark/${endpoint}/${questionId}`);
}
...
function setupEventListeners(elements) {
    ...
    addBookmarkButtonEventListener(questionView, questionId);
...
function addBookmarkButtonEventListener(questionView, questionId) {
    if (getAuthData()) {
        ...
        if (bookmarkButton) {
            bookmarkButton.addEventListener('click', (e) => {
                ...
                if (bookmarked) {
                    ...
                    sendBookmark(questionId, false);
                } else {
                    bookmarkButton.dataset.bookmarked = 'true';
                    sendBookmark(questionId, true);
                }
            });
        }
    }
...
async function initializeQuestionView(questionContainer, questionId, questionLocation, divId, directView = false) {
    ...
    question.user_authenticated = !!getAuthData();
